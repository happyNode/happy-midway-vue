  ...
  <div class="sys-task-log-container">
    <table-layout>
      <s-table ref="logTable" :data-request="getTaskLogList" show-pagination border>
        <el-table-column prop="taskLogId" label="#" align="center" width="80" />
        <el-table-column prop="taskId" label="任务编号" align="center" width="100" />
        <!-- <el-table-column prop="taskName" show-overflow-tooltip label="任务名称" align="center" width="200" /> -->
        ...
        <el-table-column prop="result" label="状态" width="100" align="center">
          <template slot-scope="scope">
            <el-tag size="small" :type="getStatusType(scope.row.result)" effect="dark">{{
              getStatusTip(scope.row.result)
            }}</el-tag>
          </template>
        </el-table-column>
